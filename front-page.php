...
<?php if (cat_have_posts('issue-briefs') || cat_have_posts('resources')): ?>
	<section>		
		<article id="updates">
			<h1>Updates</h1>
			<?php $briefs = new WP_Query('category_name=issue-briefs&posts_per_page=3');
				$x = 0;
			...
			<div class="itemblock clearfix">
				...
				<div class="itemnull clearfix">&nbsp;</div>
			...
			<?php $resources = new WP_Query('category_name=resources,reports&posts_per_page=3');
				$x=0;
